...
public class OpportunityWithTypeLeadSourceUser {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String orgName = eLib.getDataFromExcelFile("Opportunity ", 7, 1) + jLib.getRandomNumber();
		String OppName = eLib.getDataFromExcelFile("Opportunity ", 7, 2);
		String type = eLib.getDataFromExcelFile("Opportunity ", 7, 3);
		String leadSource = eLib.getDataFromExcelFile("Opportunity ", 7, 4);
		String assiUser = eLib.getDataFromExcelFile("Opportunity ", 7, 5);
		String salesStage = eLib.getDataFromExcelFile("Opportunity ", 7, 6);
		...
		WebElement typeDropdown = driver.findElement(By.xpath("//select[@name='opportunity_type']"));
		Select s1 = new Select(typeDropdown);
		s1.selectByVisibleText(type);

		WebElement leadSourceDropdown = driver.findElement(By.xpath("//select[@name='leadsource']"));
		Select s2 = new Select(leadSourceDropdown);
		s2.selectByVisibleText(leadSource);
