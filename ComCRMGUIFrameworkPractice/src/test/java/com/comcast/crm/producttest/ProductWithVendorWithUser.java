...
public class ProductWithVendorWithUser {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String prodName = eLib.getDataFromExcelFile("Products", 4, 1) + jLib.getRandomNumber();
		String vendName = eLib.getDataFromExcelFile("Products", 4, 2);
		String user = eLib.getDataFromExcelFile("Products", 4, 3);
		...
		WebElement userDorpdown = driver.findElement(By.xpath("//select[@name='assigned_user_id']"));
		Select s3 = new Select(userDorpdown);
