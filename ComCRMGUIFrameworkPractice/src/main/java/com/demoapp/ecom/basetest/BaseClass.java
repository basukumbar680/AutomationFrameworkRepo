package com.demoapp.ecom.basetest;
...
import com.demoapp.ecom.generic.fileutility.FileUtility;
import com.demoapp.ecom.generic.objectrepo.HomePage;
import com.demoapp.ecom.generic.objectrepo.LoginPage;
...
public class BaseClass {
	...
	public void configBM() {
		...
		String email = System.getProperty("Email", fLib.getDataFromPropertiesFile("Email"));
		String pwd = System.getProperty("Password", fLib.getDataFromPropertiesFile("Password"));
		LoginPage lp = new LoginPage(driver);
		lp.loginToApplication(url, email, pwd);
	}
